...
| PBS (phosphate buffered saline), 1X, 500 mL | CryoKing PBS-500-1-G | [Amazon.ca](https://www.amazon.ca/CryoKing-Phosphate-Filtration-Sterilize-Laboratory/dp/B0F37JVYPM) | ~$15-20 | Ready-to-use salt solution at pH 7.4. Open the bottle and use it — no mixing or dissolving. 500 mL is way more than you need (~50 mL total). |
